...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_close.setGeometry(QtCore.QRect(0, 430, 93, 28))
        self.pushButton_close.setObjectName("pushButton_close")
        self.pushButton_del = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_del.setGeometry(QtCore.QRect(610, 430, 93, 28))
        self.pushButton_del.setObjectName("pushButton_del")
        self.pushButton_change_price = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_change_price.setGeometry(QtCore.QRect(492, 430, 111, 28))
        ...
        self.pushButton_update.setGeometry(QtCore.QRect(390, 430, 93, 28))
